...
ESS_DDPG_config.hidden = (256,)  # need to keep this fixed
...
ESS_MODEL_DIR = f'./Models/ESS/Test/Train_5kWh_0_5C/SAFE_DDPG_N_step_{ESS_DDPG_config.n_step}Y_100_RES_60mins_SEED{ESS_DDPG_config.seed}'
