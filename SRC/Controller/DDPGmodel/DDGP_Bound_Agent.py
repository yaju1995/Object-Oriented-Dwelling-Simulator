...
class DPGAgent:
    ...
    def select_action(self, state, noise_std=0.1, bound_fn=None):
    ...
    def train(self, batch_size=64):
        ...
        next_action = self.scale_action(raw_next_action, a_min=a_min_tensor, a_max=a_max_tensor)
        ...
        scaled_action = self.scale_action(raw_action, a_min_tensor, a_max_tensor)
