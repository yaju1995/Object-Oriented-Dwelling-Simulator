...
if TARIFF_TYPE == 'TOU':
    ...
    House.tariff.upload_historic_tariff('../SRC/SIM/Defaults/Tariff/Irish_wholesale_2026Entsoe.csv')
    House.tariff.upload_historic_feed_tariff('../SRC/SIM/Defaults/Tariff/Irish_wholesale_2026Entsoe.csv')
...
SEED = 0
TEST_EPS = 500
Controller.load_models(episode=300)
random.seed(SEED)
day = 0
