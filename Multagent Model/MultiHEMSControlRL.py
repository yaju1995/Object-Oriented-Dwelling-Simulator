...
from SRC.Controller.Constants import COLUMNS_KEYS
...
if EV_CONTROL_TYPE == 'RL':
    # RL based ~~~~~~~
    # from SRC.Controller.EV_controller.evControlLib_General import ev_controller
    from Multi_EV_CONFIG import EV_DDPG_config, EV_LOOK_AHEAD, EV_INPUT_DIM, EV_OUT_DIM,EV_MODEL_DIR,EV_MODEL_NAME
    # #
...
class HEMSController:
    ...
    def update(self, ev_info: EVModel, inverter_info: InverterModel, hvac_info: HVACModel, meter_info: MeterModel):
        ...
        row = {  # Base on Constants COLUMNS_KEYS
            ...
            'Temperature - Ref (C)': hvac_info.temp_ref or 0
        }
